...
namespace VHierarchy
{
    class VHierarchyMenu
    {
        ...
        public static bool autoRoleIconEnabled { get => EditorPrefsCached.GetBool("vHierarchy-autoRoleIconEnabled", true); set => EditorPrefsCached.SetBool("vHierarchy-autoRoleIconEnabled", value); }




        const string dir = "Tools/vHierarchy/";
        const string customDir = "Tools/自制工具栏/vHierarchy/";
        ...
        const string autoRoleIcon = dir + "Auto role icon";
        const string autoRoleIconCustom = customDir + "Auto role icon";
        ...
        [MenuItem(autoRoleIconCustom, false, 20)] static void vtn_toggle_auto_role_icon() { autoRoleIconEnabled = !autoRoleIconEnabled; EditorApplication.RepaintHierarchyWindow(); }
        [MenuItem(autoRoleIconCustom, true, 20)] static bool vtn_toggle_auto_role_icon_validate() { Menu.SetChecked(autoRoleIconCustom, autoRoleIconEnabled); return !pluginDisabled; }
